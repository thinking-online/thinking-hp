  ...
  const categories = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          q: "合格率はどのくらいですか？",
          a: "ひとことで率だけをお答えするのが難しい部分があります。4月時点の第一志望が、夏以降に変わることもありますし、「最終的に本気で行きたいと決めた大学」を第一志望と数えるのか、出願時点の並びをどう見るのかでも数字の意味が変わります。THINKING. では徹底的に数値管理をしており、無謀な受験をさせず、早い段階から志望のランクを戦略的に見直すこともあります。日々の小テストや実力テスト、ロードマップ上の進捗などを総合し、データに基づいて出願戦略を組み立て、合格可能性をいかに最大化するかを一緒に設計していきます。",
        },
      ],
    },
    {
