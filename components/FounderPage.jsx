...
const FounderPage = () => {
  ...
  },
  {
    no: "02",
    title: "全員には、教えない。",
    body: "30年近く教育業界にいて、わかったことがあります。「全員に同じ授業」は、誰のためにもなりません。だから私たちは、見られる人数しか受け入れません。月10名、これが私たちの限界であり、矜持です。"
  },
  {
    no: "03",
    title: "数字より、ひとりの物語を。",
  ...
  return (
    <>
      <PageHeader
        ...
        lead="THINKING. 代表 — 朝倉 徹大。30年近く受験指導に携わってきた人間として、いま考えていることを、お話しさせてください。"
