...
const FounderPage = () => {
  const timeline = [
    ...
    { year: "2025", event: "受講生のべ1,800名規模へ。第一志望合格率62%を維持しながら、月10名限定の方針は変えない。" },
  ];
  ...
  },
  {
    no: "03",
    title: "数字より、ひとりの物語を。",
    body: "合格率や偏差値の伸びも大切です。それ以上に大切なのは、10代後半の1〜2年をどんな密度で過ごすかです。受験は通過点。でも、人生を変えうる通過点。その過程で身につく自走力と戦略眼は、一生ものになります。私はそこに最も価値を置いています。"
  }];
      ...
      <section className="founder-essay">
        <div className="founder-essay-inner">
          ...
          <div className="founder-essay-body">
            ...
            <p>
              だからこそ、私たちは<em>月10名</em>という、あえて小さな枠にこだわります。コーチが日々の進捗と志望学部の戦略を握り切れる人数には限界があるからです。問い合わせをお断りすることもありますが、<em>「数を取って質を落とす」ことだけは、したくない</em>。少数だからこそ、第一志望合格率62%という数字を、毎年積み上げられています。
            </p>
