...
.head .name{font-size:13px;color:#333;border-bottom:1px solid #999;min-width:160px;text-align:center;padding-bottom:2px}
...
<div class="wrap">
 ...
 <div class="head"><div class="ttl">{esc(title)} 単語テスト</div><div class="name">氏名</div></div>
